...
\begin{itemize}
	...
	\item $\vb{E}_{\text{above}}^{\perp} - \vb{E}_{\text{below}}^{\perp}  = \sigma_f/\epsilon_0$
...
Divergence:\\
\tab \hspace{-0.2mm}$\ds \div{\vb{v}} = \frac{1}{r^2}\pdv{r}(r^2v_r) + \frac{1}{r\sin\theta}\pdv{\theta}(\sin\theta v_\theta) + \frac{1}{r\sin\theta}\pdv{v_\phi}{\phi}$
